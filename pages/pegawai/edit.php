...
<?php
$ambil = mysqli_query($db, "SELECT * FROM pegawai where id_pegawai='$_GET[id_edit]'");
...
<div class="row">
  <div class="col-8">
    <div class="card card-body border-0 shadow mb-4">
      ...
      <form method="post"
        action="/websm3/projectuas/proses/proses_pegawai.php?aksi=update&id_edit=<?= $data['id_pegawai'] ?>">
        <div class="row align-items-center">
          ...
          <div class="col-md-12 mb-3">
            <div>
              ...
              <input class="form-control" id="umur" name="umur" type="number" value="<?= $data['umur'] ?>" required>
            </div>
          </div>          
          <div class="col-md-12 mb-3">
          ...
          <div class="col-md-12 mb-3">
            <div>
              ...
              <input class="form-control" id="kontak" name="kontak" type="number" value="<?= $data['no_hp'] ?>" required>
            </div>
          </div>          
        </div>       
        <div class="col-md-12 mb-3">
            <div>
              ...
              <input class="form-control" id="alamat" name="alamat" type="text" value="<?= $data['alamat'] ?>" required>
            </div>
          </div> 
        <div class="mt-3">
