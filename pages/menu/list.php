...
<nav class="px-2 mb-4 d-flex w-100 justify-content-between" aria-label="breadcrumb" class="d-none d-md-inline-block">
  ...
  if ($_SESSION['level'] == 'admin'): ?>
    <div class="btn-toolbar mb-2 mb-md-0">
      <a href="index.php?p=menu&page=input" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-centered table-nowrap mb-0 rounded text-center">
        ...
        <?php
        $tampil = mysqli_query($db, "SELECT * FROM menu, otlet WHERE menu.id_otlet = otlet.id_otlet");
        $no = 1;
        while ($data = mysqli_fetch_array($tampil)) {
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div>
                  <a href="index.php?p=menu&page=edit&id_edit=<?= $data['id_menu'] ?>">
                  ...
                  |
                  <a href="proses/proses_menu.php?aksi=delete&id_hapus=<?= $data['id_menu'] ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
