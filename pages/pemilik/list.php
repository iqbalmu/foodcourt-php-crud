...
<nav class="px-2 mb-4 d-flex w-100 justify-content-between" aria-label="breadcrumb" class="d-none d-md-inline-block">
  ...
  <div class="btn-toolbar mb-2 mb-md-0">
    <a href="index.php?p=pemilik&page=input" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-centered table-nowrap mb-0 rounded text-center">
            ...
            <?php
                $tampil = mysqli_query($db, "SELECT * FROM pemilik");
                $no = 1;
              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                    <div>
                        <a href="index.php?p=pemilik&page=edit&id_edit=<?= $data['id_pemilik'] ?>">
                        ...
                        |       
                        <a href="proses/proses_pemilik.php?aksi=delete&id_hapus=<?= $data['id_pemilik'] ?>">
