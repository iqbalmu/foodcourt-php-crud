...
<nav class="px-2 mb-4 d-flex w-100 justify-content-between" aria-label="breadcrumb" class="d-none d-md-inline-block">
  ...
  <div class="btn-toolbar mb-2 mb-md-0">
    <a href="index.php?p=users&page=input" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <?php
              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                    <div>
                        <a href="index.php?p=users&page=edit&username=<?= $data['username'] ?>">
                        ...
                        |       
                        <a href="proses/proses_users.php?aksi=delete&username=<?= $data['username'] ?>">
